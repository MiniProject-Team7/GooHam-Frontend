      ...
      <div className="flex items-center">
          ...
          <Card className="w-[500px] h-[700px] mt-[50px] mr-[100px] p-6 flex flex-col border-none shadow-none">
            ...
            <CardContent className="space-y-4">
              <div className="flex flex-col">
                <label htmlFor="signup-email" className="mb-1 font-bold">
                  이메일
                </label>
                <Input
                  id="signup-email"
              ...
              <div className="mt-8 flex flex-col">
                <label htmlFor="signup-password" className="mb-1 font-bold">
                  비밀번호
                </label>
            ...
            <CardFooter className="mt-auto flex flex-col gap-3 px-6">
              ...
              <Button className="block w-3/4 mx-auto" onClick={handleNext}>
                다음 단계 진행하기
              </Button>
            </CardFooter>
          </Card>
        ...
        {step === 2 && (
          <Card className="w-[500px] mt-[50px] mr-[100px] p-6 flex flex-col border-none shadow-none">
            ...
            <CardContent className="space-y-4">
              <div className="flex flex-col">
                <label htmlFor="signup-name" className="mb-1 font-bold">
                  이름*
                </label>
                <Input
                  id="signup-name"
              ...
              <div className="flex flex-col">
                <label htmlFor="signup-nickname" className="mb-1 font-bold">
                  닉네임*
                </label>
                <Input
                  id="signup-nickname"
              ...
              <div className="flex flex-col">
                <label htmlFor="signup-birth" className="mb-1 font-bold">
                  생년월일*
                </label>
                <Input
                  id="signup-birth"
              ...
              <div className="flex flex-col">
                <label htmlFor="signup-phone" className="mb-1 font-bold">
                  전화번호*
                </label>
                <Input
                  id="signup-phone"
            ...
            <div className="mt-4 px-6">
              ...
              <div className="border-t border-gray-300 my-2" />
              <ActionButtonSection selected={selectedCats} onChange={handleCatChange} />
              {categoryError === "required" && (
                <p className="mt-1 text-center text-sm text-red-500">
                  최소 1개부터 최대 3개까지의 카테고리를 선택해 주세요.
                </p>
              )}
            </div>
            ...
            <CardFooter className="mt-auto flex flex-col gap-3 px-6">
              <Button
                variant="outline"
                className="block w-3/4 mx-auto border-gray-300"
                onClick={handleBackToStep1}
              >
                뒤로 가기
              </Button>
              <Button className="block w-3/4 mx-auto" onClick={handleSignup}>
                회원가입 완료하기
              </Button>
            </CardFooter>
          </Card>
        ...
        {step === 3 && (
          <Card className="w-[500px] mt-[50px] mr-[100px] p-6 flex flex-col border-none shadow-none">
            ...
            <CardFooter className="mt-auto flex flex-col gap-3 px-6 mr-[45px] ml-[45px]">
              <Link href="/" className="block w-4/4 mx-auto">
                <Button variant="outline" className="w-full border-gray-300">
                  메인 가기
                </Button>
              </Link>
              <Link href="/account/signin" className="block w-4/4 mx-auto">
