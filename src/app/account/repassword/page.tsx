  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-pink-50">
      <Card className="w-full max-w-sm p-6 space-y-6">
        <h1 className="text-center text-2xl font-bold">GooHam 회원가입</h1>
        ...
        {step === 1 ? (
          <>
            <CardContent className="space-y-4">
              ...
              <div className="flex flex-col">
                <label htmlFor="signup-password" className="mb-1 font-medium">
                  비밀번호
                </label>
                <Input
                  id="signup-password"
              ...
              <div className="flex flex-col">
                <label htmlFor="signup-confirm" className="mb-1 font-medium">
                  비밀번호 확인
                </label>
                <Input
                  id="signup-confirm"
          ...
          <>
            <CardContent className="space-y-4">
              ...
              <div className="flex flex-col">
                <label htmlFor="signup-nickname2" className="mb-1 font-medium">닉네임</label>
                <Input
                  id="signup-nickname2"
