  ...
  return (
    <footer className="w-full py-10 bg-white">
      <div className="container max-w-7xl mx-auto px-4">
        ...
        <nav className="mb-6">
          <ul className="flex flex-wrap gap-2 font-medium text-[#8e8e93] text-xl">
        ...
        <div className="font-medium text-[#8e8e93] text-xl mb-2">
          © 2025 GooHam. All rights reserved.
        </div>

        {/* Company name and tagline */}
        <div className="font-medium text-[#8e8e93] text-xl mb-6">
          구함(GooHam)
          <br />
          함께하는 즐거움, 구함과 시작하세요!
        </div>
        ...
        <div className="flex items-center mt-4">
          ...
          <div className="ml-2 font-medium text-[#8e8e93] text-xl">
